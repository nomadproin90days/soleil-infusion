export const HOME_TRANSLATIONS = {
  en: {
    ...
    claimLabel: "Exclusive Promotion",
    claimHeadline: "Claim Your Launch Offer",
    claimSub: "Enter your details below to lock in your 'Buy 2, Get 1 FREE' credit. Our team will apply this to your first visit.",
  ...
  ko: {
    ...
    claimLabel: "단독 프로모션",
    claimHeadline: "오픈 기념 혜택 신청하기",
    claimSub: "아래에 정보를 입력하여 '2+1 무료' 혜택을 선점하세요. 첫 방문 시 혜택이 적용됩니다.",
    locationLabel: "방문 안내",
  ...
  vi: {
    ...
    claimLabel: "Khuyến Mãi Đặc Biệt",
    claimHeadline: "Nhận Ưu Đãi Khai Trương",
    claimSub: "Nhập thông tin bên dưới để giữ chỗ ưu đãi 'Mua 2 tặng 1 MIỄN PHÍ'. Đội ngũ của chúng tôi sẽ áp dụng ưu đãi này cho lần thăm khám đầu tiên của bạn.",
